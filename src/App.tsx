...
function App() {
  return (
    <>
        ...
        <section className="justify-center lg:flex lg:h-[90vh] lg:flex-col">
          <div className="my-16 flex flex-col justify-between gap-8 lg:m-0 lg:flex-row">
            ...
            <div className="h-[242px]s flex flex-col justify-between sm:h-[280px] md:h-[340px]  lg:h-auto lg:max-w-[740px] lg:justify-evenly">
              <h2 className="mx-auto max-w-[445px] font-serif text-3xl leading-[3rem] sm:max-w-none sm:text-[42px] sm:leading-[3.8rem] md:text-[52px] md:leading-[4.2rem]">
      ...
      <footer className="my-8 mx-auto flex w-[94%] max-w-[1200px] cursor-pointer flex-col rounded-xl bg-primary py-8 px-8 text-white transition duration-300 ease-out hover:scale-105 sm:py-20 lg:py-[60px] lg:px-[100px]">
