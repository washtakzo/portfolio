...
const Technologie = ({ image, title }: techno) => {
  return (
    <div className="flex flex-col justify-around items-center p-4 m-4 shadow-2xl rounded-lg mx-auto w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-52 lg:h-52">
